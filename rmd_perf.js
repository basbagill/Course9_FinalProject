...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 32 }, { marker: 'pandoc', elapsed: 32 }, { marker: 'post-processor', elapsed: 34 }, { marker: 'pre-processor', elapsed: 2 }, { marker: 'render', elapsed: 268 } ];
